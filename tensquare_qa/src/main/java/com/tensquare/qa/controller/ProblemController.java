...
public class ProblemController {
	...
	public Result newlist(@PathVariable String labelid,@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,StatusCode.OK,"最新列表",new PageResult<Problem>(pageDate.getTotalElements(),pageDate.getContent()));
	}
	...
	public Result hotlist(@PathVariable String labelid,@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,StatusCode.OK,"最热列表",new PageResult<Problem>(pageDate.getTotalElements(),pageDate.getContent()));
	}
	...
	public Result waitlist(@PathVariable String labelid,@PathVariable int page,@PathVariable int size){
		...
		return new Result(true,StatusCode.OK,"等待回答",new PageResult<Problem>(pageDate.getTotalElements(),pageDate.getContent()));
	}
	/**
	 * 查询全部数据
	 * @return
